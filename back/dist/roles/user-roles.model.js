...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, primaryKey: true, autoIncrement: true, unique: true }),
...
exports.UserRoles = UserRoles = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'userRoles', createdAt: false, updatedAt: false })
], UserRoles);
